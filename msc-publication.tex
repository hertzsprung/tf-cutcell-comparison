...
\begin{itemize}
	\item l2 error is $\sim 10 \times$ worse on SLEVE compared to BTF, slightly worse again on cut cell grid
	\item Conclusions/summary: Accuracy depends upon alignment of flow with grid.  Accuracy not reduced by grid distortions.  Accuracy on BTF grid comparable with accuracy on SLEVE grid in horizontal advection test.
\end{itemize}
