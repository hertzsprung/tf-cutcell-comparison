...
The hybrid terrain following (HTF) coordinates of \citet{simmons-burridge1981} improve upon BTF coordinates by using a decay function that allows the influence of the terrain to be removed at a specified height, producing flat model layers aloft.  \TODO{include equation?}
...
\centering
\footnotesize
\begin{tabular}{ r @{\hspace{0.5em}} l l l | l l l | l l l | l l l}
\hline\hline
