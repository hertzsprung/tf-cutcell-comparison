...
In this section we describe the formulation of the terrain following grids and the method of cut cell grid construction.  The techniques presented here are used to define the grids for the experiments in the subsequent section.
...
\section{Conclusions}
\begin{enumerate}
	\item Results can be accurate on a highly-distorted grid such as BTF.  We found that:
	\begin{itemize}
