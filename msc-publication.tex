...
% 	     l2		     min	     max	   l2		    min		     max           l2                        min                       max          l2                         min                       max
BTF 	   & \num{0.0210}  & \num{-0.275}  & \num{0.925} & \num{0.00791}  & \num{-0.0446}  & \num{0.925} & \num{0.00251}           & \num{-0.0245}           & \num{0.985} & \num{0.00154}           & \num{-0.0110}           & \num{0.983} \\
SLEVE      & \num{0.00233} & \num{-0.0252} & \num{0.985} & \num{0.00108}  & \num{-0.0106}  & \num{0.982} & \num{0.0173}            & \num{-0.120}            & \num{0.950} & \num{0.0120}            & \num{-0.0263}           & \num{0.865} \\
Cut cell   & \num{0.00224} & \num{-0.0251} & \num{0.985} & \num{0.000577} & \num{-0.00674} & \num{0.983} & \num{13.6}              & \num{-623}              & \num{3480}  & \num{0.0134}            & \num{-0.028}            & \num{0.851} \\
No terrain & \num{0.00223} & \num{-0.0251} & \num{0.985} & \num{0.000576} & \num{-0.00674} & \num{0.983} & \multicolumn{1}{c}{---} & \multicolumn{1}{c}{---} & {---}       & \multicolumn{1}{c}{---} & \multicolumn{1}{c}{---} & \multicolumn{1}{c}{---} \\
\hline
\end{tabular}
\end{table*}
