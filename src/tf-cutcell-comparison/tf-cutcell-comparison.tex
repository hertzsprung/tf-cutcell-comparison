...
Similar accuracy is obtained for both centred linear and upwind-biased cubic schemes on the BTF grid (figures~\ref{fig:advection-tracer}c and~\ref{fig:advection-tracer}e).  However, results are substantially improved by using the upwind-biased cubic scheme on the cut cell grid (figures~\ref{fig:advection-tracer}d and~\ref{fig:advection-tracer}f).
...
%
	\caption{Tracer contours advected in a terrain following velocity field at \(t = \SI{0}{\second}\), \SI{5000}{\second} and \SI{10000}{\second} using (a) the upwind-biased cubic scheme on the BTF grid, and (b) the centred linear scheme on the cut cell grid with contour intervals every 0.1.  Errors at \(t = \SI{10000}{\second}\) are shown for (c) the the upwind-biased cubic scheme on the BTF grid, (d) the centred linear scheme on the cut cell grid, (e) the centred linear scheme on the BTF grid, and (f) the upwind-biased cubic scheme on the cut cell grid with contour intervals every 0.01.  Negative contours denoted by dotted lines.  The terrain profile is also shown immediately above the $x$ axis.}
