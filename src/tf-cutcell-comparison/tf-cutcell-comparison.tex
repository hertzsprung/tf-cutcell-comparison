...
%
	\caption{\TODO{Vertical sample through x=50km (quite far to the east of the mountain) in gravity waves tests.  BTF results I have so far are in good agreement.  The cut cell results are not.  I am not yet sure if it will be worth taking sample lines through thermal advection tracer diffs because not all of them agree with the gravity waves results.  This can, perhaps, be forgiven because the wind fields differ between the advection and gravity waves tests.}}
