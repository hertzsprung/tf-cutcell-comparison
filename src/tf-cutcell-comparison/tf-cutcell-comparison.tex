...
%
	\caption{Differences in potential temperature between the start and end of the gravity waves test on the BTF grid with $\Delta z = \SI{50}{\meter}$.  Axes are in units of \si{\meter}.  \TODO{draw a dashed line at x=50km if possible}}
	\label{fig:gw-theta}
\end{figure*}
