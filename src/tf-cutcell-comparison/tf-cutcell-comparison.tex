...
The initial thermodynamic conditions have a temperature at $z=0$ of $\theta_0 = \SI{288}{\kelvin}$ and constant static stability with $N = \SI{0.01}{\per\second}$ everywhere, such that
\begin{align}
