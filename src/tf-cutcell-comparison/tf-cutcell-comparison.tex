...
For the Exner function of pressure, hydrostatic balance is prescribed on all boundaries.
...
\TODO{is this clear enough?  my point is I don't need to worry about an analytic solution where only /part/ of the tracer has been advected over the mountain range.  the analytic solution at t=18000s is symmetric about x=0.}
...
% TABLES
\begin{table}
	\caption{\TODO{mesh statistics.  BTF max/min cell area ratio is very close to 1 irrespective of resolution.}}
	\label{tab:gw-meshes}
%
\centering
...
{$\Delta z$ (\si{\meter})} & {cut cell max/min cell area ratio} & {BTF nonortho} & {cut cell nonortho} \\
\hline
300	& 4.325 & 10.2	& 7.3 \\
250	& 5.422 & 10.8	& 20.9 \\
200	& 25.36 & 10.8	& 31.9 \\
150	& 10.03 & 11.0	& 29.4 \\
125	& 10.11 & 11.1	& 24.37 \\
100	& 36.27 & 11.1	& 32.2 \\
75	& 52.89 & 11.2	& 34.2 \\
50	& 75.25 & 11.2	& 31.7 \\
\hline
...
%
	\caption{\TODO{This will eventually include a large panel showing BTF dz=50m (the best "reference" solution we have).  Below that I intend to compare BTF/cut cell results at dz=50m, between gravity waves and thermal advection tests.  These plots will zoom into a small domain covering the mountain peaks and a small part of the lee side.}}
	\label{fig:gw-theta}
\end{figure*}
