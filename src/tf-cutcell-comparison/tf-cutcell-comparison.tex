...
Enlargements of the error field near the mountain are shown in figure~\ref{fig:thermalAdvection} at $\Delta z = \SI{50}{\meter}$ with contours of potential temperature overlayed.  Errors are too small to be visible on the BTF grid with a maximum $\ell_2$ error of \TODO{\num{999}}.
