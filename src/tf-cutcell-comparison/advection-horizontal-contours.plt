...
"`echo $ATMOSTESTS_DIR`/build/advection-horizontal-linear-btf/0/T.contour.positive" using ($1/1000):($2/1000) notitle lt 1 lc 0, \
"`echo $ATMOSTESTS_DIR`/build/advection-horizontal-linear-btf/0/T.contour.negative" using ($1/1000):($2/1000) notitle dt 3 lc rgbcolor '#ff0000', \
"`echo $ATMOSTESTS_DIR`/build/advection-horizontal-linear-btf/5000/T.contour.positive" using ($1/1000):($2/1000) notitle lt 1 lc 0, \
"`echo $ATMOSTESTS_DIR`/build/advection-horizontal-linear-btf/5000/T.contour.negative" using ($1/1000):($2/1000) notitle dt 3 lc rgbcolor '#ff0000', \
"`echo $ATMOSTESTS_DIR`/build/advection-horizontal-linear-btf/10000/T.contour.positive" using ($1/1000):($2/1000) notitle lt 1 lc 0, \
"`echo $ATMOSTESTS_DIR`/build/advection-horizontal-linear-btf/10000/T.contour.negative" using ($1/1000):($2/1000) notitle dt 3 lc rgbcolor '#ff0000'

unset ylabel
set label 1 "(b)"
set title "Upwind-biased cubic scheme on cut cell grid"
plot t, schaerCos(t*1000)/1000 notitle lt 1 lc 0, \
"`echo $ATMOSTESTS_DIR`/build/advection-horizontal-cubicUpwind-cutCell/0/T.contour.positive" using ($1/1000):($2/1000) notitle lt 1 lc 0, \
"`echo $ATMOSTESTS_DIR`/build/advection-horizontal-cubicUpwind-cutCell/0/T.contour.negative" using ($1/1000):($2/1000) notitle dt 3 lc rgbcolor '#ff0000', \
"`echo $ATMOSTESTS_DIR`/build/advection-horizontal-cubicUpwind-cutCell/5000/T.contour.positive" using ($1/1000):($2/1000) notitle lt 1 lc 0, \
"`echo $ATMOSTESTS_DIR`/build/advection-horizontal-cubicUpwind-cutCell/5000/T.contour.negative" using ($1/1000):($2/1000) notitle dt 3 lc rgbcolor '#ff0000', \
...
plot t, schaerCos(t*1000)/1000 notitle lt 1 lc 0, \
"`echo $ATMOSTESTS_DIR`/build/advection-horizontal-cubicUpwind-btf/0/T.contour.positive" using ($1/1000):($2/1000) notitle lt 1 lc 0, \
"`echo $ATMOSTESTS_DIR`/build/advection-horizontal-cubicUpwind-btf/0/T.contour.negative" using ($1/1000):($2/1000) notitle dt 3 lc rgbcolor '#ff0000', \
"`echo $ATMOSTESTS_DIR`/build/advection-horizontal-cubicUpwind-btf/5000/T.contour.positive" using ($1/1000):($2/1000) notitle lt 1 lc 0, \
...
unset ylabel
set label 1 "(f)"
set title "Errors at \\(t = \\SI{10000}{\\second}\\) for (d)"
plot t, schaerCos(t*1000)/1000 notitle lt 1 lc 0, \
