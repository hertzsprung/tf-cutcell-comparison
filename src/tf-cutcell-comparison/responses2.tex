...
\end{quotation}
We have now included test results with an inversion layer that intersects the terrain, which have similar maximum vertical velocity magnitudes on terrain following and cut cell grids.  We have also included results for the original test to enable comparison with \citet{klemp2011}.
...
\end{quotation}
The advantage of the cut cell grid is not seen when the inversion layer is lowered to intersect the terrain.  We have removed the emphasis on the error reduction from the concluding remarks of section 4c.
